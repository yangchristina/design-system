...
// export type ToolbarArrayItem = ToolbarItem | ToolbarItem[]

// export type ToolbarItemType = 'separator' | 'icon-button' | 'button'
...
// const handleToolbarItems = (item: ToolbarArrayItem, orientation: 'horizontal' | 'vertical') => {
//   const isHorizontal = orientation === 'horizontal';
//   const flexDirection = isHorizontal ? 'row' : 'column'
//   const oppositeOrientation = isHorizontal ? 'vertical' : 'horizontal'
//   if (Array.isArray(item)) {
//     return (
//       <Flex direction={flexDirection} css={{ ai: 'center' }}>
//         {item.map((item, index) => {
//           return (
//             <Box key={index}>
//               {handleToolbarItems(item, orientation)}
//             </Box>
//           )
//         })}
//       </Flex>
...
//   switch (item.type) {
//     case 'separator':
//       return <Separator orientation={oppositeOrientation} size="1" css={isHorizontal ? { mr: '$3' } : { mb: '$3' }} />
//     case 'icon-button':
//       return <IconButton css={isHorizontal ? { ml: '$2' } : { mt: '$2' }}>
//         {item.children}
//       </IconButton>
//     case 'button':
//       return <Button ghost css={{ fontWeight: 400 }} {...item.props} >
//         {item.children}
//       </Button>
//   }
// }

export function Toolbar({ orientation = 'horizontal' }: { orientation?: 'horizontal' | 'vertical' }) {
  const isHorizontal = orientation === 'horizontal';
  const flexDirection = isHorizontal ? 'row' : 'column'
  const oppositeOrientation = isHorizontal ? 'vertical' : 'horizontal'
  ...
  return (
    ...
    >
      <Flex direction={flexDirection} css={{
        ...
        <Flex direction={flexDirection} css={{ alignItems: 'center' }}>
          <Box css={{ mr: '$1' }}>
            <IconButton>
              <HamburgerMenuIcon />
            </IconButton>
        ...
        <Flex direction={flexDirection} css={{ ai: 'center', gap: 6 }}>
          <Box>
            <Tooltip content="Insert (Cmd+P)" side="bottom" align="center">
              <IconButton>
                <svg
          ...
          <Separator orientation={oppositeOrientation} size="1" css={isHorizontal ? { mx: '$3' } : { my: '$3' }} />
          <Box>
            <Tooltip content="Frame (F)" side="bottom" align="center">
              <IconButton>
                <svg
        ...
        <Flex direction={flexDirection} css={{ alignItems: 'center' }}>
          <Avatar size="2" shape="circle" fallback="C" />
          <IconButton css={isHorizontal ? { ml: '$2' } : { mt: '$2' }}>
            <Share1Icon />
          </IconButton>
          <IconButton css={isHorizontal ? { ml: '$2' } : { mt: '$2' }}>
            <PlayIcon />
